...
// If expedited, the deposit to enter voting period will be increased to 5000 utheia.
...
var (
	MinExpeditedDeposit   = sdk.NewCoins(sdk.NewCoin("utheia", types.DefaultMinExpeditedDepositTokens))
